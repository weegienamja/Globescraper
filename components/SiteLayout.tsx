    ...
    <div className="avatar-dropdown" ref={ref}>
      ...
      {open && (
        <div className="avatar-dropdown__menu" role="menu">
          ...
          {isAdmin && (
            <Link href="/tools" className="avatar-dropdown__item" role="menuitem" onClick={() => setOpen(false)}>
            ...
            <>
              ...
              <div className="mobile-nav__actions">
                ...
                {session.user.role === "ADMIN" && (
                  <Link href="/tools" className="mobile-nav__action-link" onClick={() => setOpen(false)}>
