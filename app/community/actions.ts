  ...
  if (!existing) {
    ...
    await prisma.profile.create({
      data: {
        ...
        meetupStudyGroup,
        meetupLanguageExchange,
        meetupVisaHelp: meetupVisaHelp ?? false,
        meetupSchoolReferrals: meetupSchoolReferrals ?? false,
        meetupExploring: meetupExploring ?? false,
        relocationStage: (relocationStage as "PLANNING" | "SECURED_JOB" | "ARRIVED" | "TEACHING" | "RENEWING_VISA") ?? "PLANNING",
        lookingFor: lookingFor as "FIRST_JOB" | "BETTER_SCHOOL" | "FLATMATES" | "LANGUAGE_EXCHANGE" | "FRIENDS" | "TRAVEL_BUDDIES" | null ?? null,
        replyTimeHint: replyTimeHint as "WITHIN_HOUR" | "WITHIN_FEW_HOURS" | "WITHIN_DAY" | "NOT_ACTIVE" | null ?? null,
